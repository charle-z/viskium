...
| Transporte MCP local | prototyped | Tres tools versionadas; tests in-memory cubren PNG, receipt, grant/admission y el launcher stdio tiene gates sin hardware | Cliente stdio externo con cámara, revocación concurrente y soak |
