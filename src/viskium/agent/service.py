...
_SNAPSHOT_REASON_OUTCOMES: dict[str, frozenset[str]] = {
    ...
    "camera_worker_start_timeout": frozenset({"timeout"}),
    "camera_backend_init_timeout": frozenset({"timeout"}),
    "camera_device_open_timeout": frozenset({"timeout"}),
    "camera_configure_timeout": frozenset({"timeout"}),
    ...
    "camera_configure_failed": frozenset({"unavailable"}),
    "directshow_unavailable": frozenset({"unavailable"}),
    "mediafoundation_unavailable": frozenset({"unavailable"}),
    "videoio_backend_unavailable": frozenset({"unavailable"}),
    "invalid_open_response": frozenset({"unavailable"}),
    "invalid_configure_response": frozenset({"unavailable"}),
